...
export const ADDRESSES = {
  // === CELO MAINNET (NEW UUPS PROXIES) ===
  BIOTA_PASSPORT: (process.env.NEXT_PUBLIC_BIOTA_PASSPORT || '0xf2432fa271adb07b13aa6221d821a49eb57de1c0') as Address,
  BIOTA_SCROW: (process.env.NEXT_PUBLIC_BIOTA_SCROW || '0x4240fc4c59d21a3c1caed90adb981d47f933a92b') as Address,
  BIOTA_SPLITTER: (process.env.NEXT_PUBLIC_BIOTA_SPLITTER || '0x5c994bed61ed6f2b1f9a1be505e48f9b979f0850') as Address,
  BIOTA_UBI: (process.env.NEXT_PUBLIC_BIOTA_UBI || '0xa3a720717ee892f249d5cdfe629ffd8c9b95964b') as Address,
